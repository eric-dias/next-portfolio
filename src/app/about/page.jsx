  ...
  return (
    ...
    >
      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        {/* TEXT CONTAINER */}
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 lg:pr-0 xl:gap-64 lg:w-2/3 xl:w-1/2">
          {/* BIOGRAPHY CONTAINER */}
          <div className="flex flex-col gap-12 justify-center">
            ...
            <p className="text-lg">
              ...
              Voluptatibus, quas a? Veniam cumque officia quam. At voluptatem
              expedita tempore. Vel rem odit ullam eveniet earum, exercitationem
              sit iure? Quo, facilis.
            </p>
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">My current job</div>
                  {/* JOB DATE */}
                ...
                <div className="w-1/6 flex justify-center">
                  ...
                  <div className="w-1 h-full bg-gray-600 rounded relative">
                    {/* LINE CIRCLE */}
                    <div className="absolute w-5 h-5 rounded-full ring-4 ring-res-400 bg-white -left-2"></div>
                  </div>
                </div>
                {/* RIGHT */}
